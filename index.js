    ...
    <div class='card shadow-sm task__card'>
       <div class='card-header d-flex justify-content-end task__card__header'>
        ...
        <div class="card-footer">
           <button type='button' class='btn-outline-primary float-right' data-bs-toggle="modal" data-bs-target="#showtask">Open Task
           </button>
        </div>
    </div>
</div>
...
const htmlModalContent= ({ id,title,description,type,url }) =>{
    ...
    <div id=${id}>
       ${
           url &&
           `<img width='100% src=${url} lat='Card Image' class='img-fluid place__holder__image mb-3'/>`
         }
